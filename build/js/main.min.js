...
var _swiper = require("./vendor/swiper");
var _toursSlider = require("./modules/tours-slider");
var _trainersSlider = require("./modules/trainers-slider");
var _reviewsSlider = require("./modules/reviews-slider");
var _advSlider = require("./modules/adv-slider");
var _gallerySlider = require("./modules/gallery-slider");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    (0, _menu.initMenu)();
    (0, _toursSlider.initToursSlider)();
    (0, _trainersSlider.initTrainersSlider)();
    (0, _reviewsSlider.initReviewsSlider)();
    (0, _gallerySlider.initGallerySlider)();
    var advSlider = null;
    if (window.matchMedia('(min-width: 1200px)').matches) {
      advSlider = (0, _advSlider.initAdvSlider)();
    }
...
},{"./modules/adv-slider":2,"./modules/form-validate/form":4,"./modules/gallery-slider":10,"./modules/menu":11,"./modules/modals/init-modals":12,"./modules/reviews-slider":14,"./modules/tours-slider":15,"./modules/trainers-slider":16,"./utils/ios-vh-fix":19,"./vendor/swiper":21}],2:[function(require,module,exports){
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.initAdvSlider = void 0;
var initAdvSlider = exports.initAdvSlider = function initAdvSlider() {
  var swiperEl = document.querySelector('[data-adv]');
  var buttonPrev = document.querySelector('[data-adv-prev]');
  var buttonNext = document.querySelector('[data-adv-next]');
...
var initGallerySlider = exports.initGallerySlider = function initGallerySlider() {
  var swiperEl = document.querySelector('[data-gallery]');
  var buttonPrev = document.querySelector('[data-gallery-prev]');
  var buttonNext = document.querySelector('[data-gallery-next]');
...
var initMenu = exports.initMenu = function initMenu() {
  var menuBtn = document.querySelector('.header__icon-wrapper');
...
var initReviewsSlider = exports.initReviewsSlider = function initReviewsSlider() {
  var swiperEl = document.querySelector('[data-reviews]');
  var buttonPrev = document.querySelector('[data-reviews-prev]');
  var buttonNext = document.querySelector('[data-reviews-next]');
...
exports.initToursSlider = void 0;
var initToursSlider = exports.initToursSlider = function initToursSlider() {
  var swiperEl = document.querySelector('[data-tours]');
  var buttonPrev = document.querySelector('[data-tours-prev]');
  var buttonNext = document.querySelector('[data-tours-next]');
...
var initTrainersSlider = exports.initTrainersSlider = function initTrainersSlider() {
  var swiperEl = document.querySelector('[data-trainers]');
  var buttonPrev = document.querySelector('[data-trainers-prev]');
  var buttonNext = document.querySelector('[data-trainers-next]');
